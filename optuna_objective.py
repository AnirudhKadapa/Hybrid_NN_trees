...
def optuna_trainingl(model_raw:nn.Module, X_train:torch.Tensor, y_train:torch.Tensor, X_val:torch.Tensor, y_val:torch.Tensor, device, base_config:TrainingConfig, trial:optuna.Trial):
    torch._dynamo.reset()
